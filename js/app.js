...
(function () {
  ...
  // Default mystery set by day (Mon/Thu Joyful · Tue/Fri Sorrowful · Wed/Sat/Sun Glorious)
  const dow = new Date().getDay();
  const defaultSet = [ "Glorious", "Joyful", "Sorrowful", "Glorious", "Joyful", "Sorrowful", "Glorious" ][dow];
